...
public class MainFrame extends JFrame {
    ...
    /**
     * Handles MainFrame functionality.
     */
    private MainFrame() {
    ...
    /**
     * Handles setupAppContainer functionality.
     */
    private void setupAppContainer() {
        ...
        // Controller Wiring
        com.budgetapp.controller.features.DashboardController dashController = new com.budgetapp.controller.features.DashboardController(dashboardPanel);
        com.budgetapp.controller.features.TransactionController transController = new com.budgetapp.controller.features.TransactionController();
        com.budgetapp.controller.features.BudgetController budgetController = new com.budgetapp.controller.features.BudgetController();

        budgetPanel.addSaveBudgetListener(e -> {
            com.budgetapp.model.entity.Budget b = new com.budgetapp.model.entity.Budget();
        ...
        budgetPanel.setBudgetActionListener(new com.budgetapp.view.ui.BudgetView.BudgetActionListener() {
            @Override
            public void onEdit(com.budgetapp.model.entity.Budget b) {
            ...
            @Override
            public void onDelete(com.budgetapp.model.entity.Budget b) {
        ...
        com.budgetapp.controller.features.GoalController goalController = new com.budgetapp.controller.features.GoalController();
        goalPanel.addGoalListener(e -> {
            com.budgetapp.model.entity.Goal newGoal = new com.budgetapp.model.entity.Goal();
        ...
        transactionPanel.addSaveListener(e -> {
            com.budgetapp.model.entity.Transaction t = new com.budgetapp.model.entity.Transaction();
            // Set the logged in user ID to the transaction
            com.budgetapp.model.entity.User currentUser = com.budgetapp.model.session.SessionManager.getInstance().getCurrentUser();
            if (currentUser != null) {
            ...
            if (!t.isIncome()) {
                for (com.budgetapp.model.entity.Budget b : budgetController.getAllBudgets()) {
                    if (b.getCategoryName().equalsIgnoreCase(t.getCategoryName())) {
                        if (b.isOverLimit()) {
                            ...
                            new com.budgetapp.controller.features.NotifController().send("Exceeded budget for " + b.getCategoryName(), "BUDGET_EXCEEDED", currentUser != null ? currentUser.getUserID() : 0);
                            ...
                            new com.budgetapp.controller.features.NotifController().send("Nearing budget limit for " + b.getCategoryName(), "BUDGET_WARNING", currentUser != null ? currentUser.getUserID() : 0);
                        }
                    }
                }
            }
            ...
            for (com.budgetapp.model.entity.Goal g : goalController.getAll()) {
        ...
        btnLogout.addActionListener(e -> {
            new com.budgetapp.controller.features.AuthController().logout();
            rootCardLayout.show(rootPanel, "Auth");
        });
    }

    /**
     * Handles onLoginSuccess functionality.
     */
    ...
    /**
     * Handles switchPanel functionality.
     */
